...
function add() {
	...
	img_imgBlan = new Image(); //define una variable con la nueva imagen
	img_imgBlan.onload = uploadimg_blan; // establece una función para cargar la variable
	img_imgBlan.src = img_blanco;   // carga la imagen
...
function uploadimg_blan() {

	ctx.drawImage(img_imgBlan, img_x, img_y, img_width, img_height);
}
function uploadimg() {
